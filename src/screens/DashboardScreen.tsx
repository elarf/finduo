      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.bottomBar}>
            <TouchableOpacity
              style={styles.bottomBarIncome}
              onPress={() => openEntryModal('income', null)}
              accessibilityLabel="Add income"
            >
              <Text style={styles.bottomBarIcon}>↑</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.bottomBarTransfer}
            ...
            <TouchableOpacity
              ...
              onPress={() => openEntryModal('expense', null)}
        ...
        <Pressable style={styles.modalBackdrop} onPress={() => setShowEntryModal(false)}>
          <Pressable style={[styles.modalCard, styles.entryModalCard]} onPress={(event) => event.stopPropagation()}>
            <View style={styles.entryTopRow}>
              ...
              />
              <TouchableOpacity style={styles.entryAccountBtn} onPress={cycleEntryAccount}>
